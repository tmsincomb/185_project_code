 ...
 */
public class Custom_GenericDialog extends Dialog implements ActionListener, TextListener,
  ...
  public void Custom_GenericDialog(){
  ...
  public Custom_GenericDialog(String title) {
  ...
  public Custom_GenericDialog(String title, Frame parent) {
    super(title == null ? null : new Frame(), title, true);
    //super(parent==null ? new Frame():parent, title, true);
    if (false){//Prefs.blackCanvas) {
